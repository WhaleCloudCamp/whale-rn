...
export default class Slides extends React.Component {
  ...
  renderRow(obj, index) {
    if (typeof this.props.renderRow === 'function') {
      return this.props.renderRow(obj, index);
    }
    return null;
  }
  ...
  onPress(obj, index) {
    if (typeof this.props.onPress === 'function') {
      return this.props.onPress(obj, index);
    }
    return null;
  }
  ...
  onWillChange(obj, index) {
    if (typeof this.props.onWillChange === 'function') {
      return this.props.onWillChange(obj, index);
    }
    return null;
  }
  ...
  onDidChange(obj, index) {
    if (typeof this.props.onDidChange === 'function') {
      return this.props.onDidChange(obj, index);
    }
    return null;
  }
